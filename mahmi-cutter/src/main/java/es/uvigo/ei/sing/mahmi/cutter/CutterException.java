...
/**
 * {@linkplain CutterException} is the MAHMI {@code Cutter} custom
...
public final class CutterException extends RuntimeException {
	...
	/**
	 * Creates a new instance of {@code CutterException} from a message and a
	 * cause
	 * 
	 * @param message
	 *            The exception message
	 ...
	 * @return A new instance of {@code CutterException}
	 */
	public static CutterException withMessageAndCause(final String message, final Throwable cause) {
