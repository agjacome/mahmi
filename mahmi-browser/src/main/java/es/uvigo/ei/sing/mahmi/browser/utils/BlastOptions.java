...
public class BlastOptions {	
     ...
     * 
     * @param num_alignments The alignments shown
     * @param evalue The expect value (E) for saving hits
     * @param blast_threshold The minimum score to add a word to the BLAST lookup table
     * @param window_size The multiple hits window size
     * @param word_size The word size of initial match
     * @param best_hit_overhang The Best Hit algorithm overhang value
     * @param best_hit_score_edge The Best Hit algorithm score edge value
     * @param gapextend The cost to extend a gap
     * @param gapopen The cost to open a gap
     * @param ungapped Whether to perform an ungapped alignment
     */
