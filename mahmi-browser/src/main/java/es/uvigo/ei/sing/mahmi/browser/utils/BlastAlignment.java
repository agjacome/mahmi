 ...
 *
 */
@XmlRootElement(name = "blastAlignment")
...
public class BlastAlignment {
	...
	/**
	 * The {@linkplain BlastAlignment} parameterized constructor using a
	 * {@linkplain BlastAlignment} instance
	 * 
	 * @param alignment
	 *            The {@linkplain BlastAlignment} to clone
	 */
	 ...
	 *            The sequence to align
	 * @param score
	 *            The sum of the scoring matrix values in the segment pair being
	 *            displayed
	 * @param eValue
	 *            The number of times one might Expect to see such a match
	 *            merely by chance
	 * @param identities
	 *            The number and fraction of total residues in the HSP which are
	 *            identical
	 * @param positives
	 ...
	 *            The query amino acid from which the alignment begins
	 * @param queryEnd
	 *            The query The amino acid from which the alignment ends
	 * @param subjectStart
	 *            The subject amino acid from which the alignment begins
	 * @param subjectEnd
	 *            The subject The amino acid from which the alignment ends
	 */
	...
	/**
	 * The {@linkplain BlastAlignment} parameterized constructor without
	 * sequence
	 * 
	 * @param description
	 *            The brief description of the alignment
	 ...
	 * 
	 * @return the sum of the scoring matrix values in the segment pair being
	 *         displayed
	 */
	 ...
	 * 
	 * @return the number of times one might Expect to see such a match merely
	 *         by chance
	 */
	 ...
	 * 
	 * @return the number and fraction of total residues in the HSP which are
	 *         identical
	 */
	 ...
	 * 
	 * @return the number and fraction of residues for which the alignment
	 *         scores have positive values
	 */
	 ...
	 * 
	 * @param positives
	 *            The he number and fraction of residues for which the alignment
	 *            scores have positive values
	 */
	 ...
	 * 
	 * @param gaps
	 *            The number of gaps of the alignment
	 */
	 ...
	 * 
	 * @param subjectStart
	 *            The subject amino acid from which the alignment starts
	 */
